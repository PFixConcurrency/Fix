...
public class ImportPath {
    ...
    //要加载的examples工程根路径
    public static String examplesRootPath = "C:\\Users\\lhr\\Desktop\\pfix\\save\\FixExamples";
...
//    public static String projectName = "account";
    public static String projectName = "pingpong";
    //这个项目的主类名称
    public static String mainClassName = "PingPong";
